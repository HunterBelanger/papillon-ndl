...
void init_URRPtable(py::module& m) {
  ...
  py::class_<URRPTables, std::shared_ptr<URRPTables>>(m, "URRPTables")
      ...
      .def("evaluate_xs_band", py::overload_cast<double, std::size_t, std::size_t>(&URRPTables::evaluate_xs_band, py::const_))
      .def("evaluate_xs_band", py::overload_cast<double, std::size_t>(&URRPTables::evaluate_xs_band, py::const_))
