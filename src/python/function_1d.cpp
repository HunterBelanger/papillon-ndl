...
class PyTabulated1D : public Tabulated1D {
  public:
    ...
    std::vector<Interpolation> interpolation() const override {
      PYBIND11_OVERRIDE_PURE(std::vector<Interpolation>, Tabulated1D, interpolation); 
    }
...
void init_Function1D(py::module& m) {
  py::class_<Function1D, PyFunction1D, std::shared_ptr<Function1D>>(m, "Function1D")
    .def(py::init<>())
...
void init_Polynomial1D(py::module& m) {
  py::class_<Polynomial1D, Function1D, std::shared_ptr<Polynomial1D>>(m, "Polynomial1D")
...
void init_Tabulated1D(py::module& m) {
  py::class_<Tabulated1D, PyTabulated1D, std::shared_ptr<Tabulated1D>>(m, "Tabulated1D")
    .def(py::init<>())
...
void init_Region1D(py::module& m) {
  py::class_<Region1D, Tabulated1D, std::shared_ptr<Region1D>>(m, "Region1D")
    .def(py::init<const std::vector<double>&, const std::vector<double>&, Interpolation>())
