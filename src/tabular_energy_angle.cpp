...
namespace pndl {
  ...
  TabularEnergyAngle::TabularEnergyAngle(const ACE& ace, size_t i): incoming_energy_(), tables_() {
  ...
  AngleEnergyPacket TabularEnergyAngle::sample_angle_energy(double E_in, std::function<double()> rng) const {
    ...
    // mu has already ben verified by the EenergyAngleTable to be in interval [-1,1]
